        ...
        <div class="row align-items-center">
            ...
            <table class="table table-striped" style="table-layout: fixed;">
                ...
                <tr>
                    ...
                    <td style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-decoration: none;">
                        <a href="viewContent.jsp?category=1&postNo=<%=list.get(i).getPost_no()%>" class="post_title">
